...
#
# ╔═══════════════════════════════════════════════════════════════════╗
# ║      🚀 PSIPHON CONDUIT MANAGER v1.2 (IRANUX PRO FINAL)          ║
# ║                                                                   ║
...
#═══════════════════════════════════════════════════════════════════════
# 5. Deploy (Using ORIGINAL IMAGE with FALLBACK)
#═══════════════════════════════════════════════════════════════════════
run_conduit() {
    ...
    if docker pull "$CONDUIT_IMAGE"; then
        ...
        # This triggers ONLY if the original image is denied/unavailable
